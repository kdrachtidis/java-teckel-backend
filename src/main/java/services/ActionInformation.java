...
@Path("action")
public class ActionInformation extends Application{
...
private HANAConnector hanaConnector;
    ...
    public Response getAction(@PathParam("story") String story) {
    	hanaConnector = new HANAConnector();
    	String value = hanaConnector.executeQuery("SELECT * FROM " + HANAConnector.tableName + " WHERE ID = 'Actions' AND STORY = '" + story + "'");
    	if (value != null) {
