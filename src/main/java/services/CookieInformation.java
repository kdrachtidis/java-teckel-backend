...
@Path("cookie")
public class CookieInformation extends Application{
    ...
    public Response getFiles(@PathParam("story") String story) {
    	...
    	String value = hanaConnector.executeQuery("SELECT * FROM " + HANAConnector.tableName + " WHERE ID = 'Cookie' AND STORY = '" + story + "'");
    	if (value != null) {
