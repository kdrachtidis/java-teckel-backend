...
@Path("experience")
public class ExperienceInformation extends Application{
    ...
    public Response getFiles(@PathParam("story") String story) {
    	...
    	String value = hanaConnector.executeQuery("SELECT * FROM " + HANAConnector.tableName + " WHERE ID = 'Experience' AND STORY = '" + story + "'");
    	if (value != null) {
