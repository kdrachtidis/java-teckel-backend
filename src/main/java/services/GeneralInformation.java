...
@Path("general")
public class GeneralInformation extends Application{
    ...
    public Response getFiles(@PathParam("story") String story) {
    	...
    	String value = hanaConnector.executeQuery("SELECT * FROM " + HANAConnector.tableName + " WHERE ID = 'General' AND STORY = '" + story + "'");
    	if (value != null) {
