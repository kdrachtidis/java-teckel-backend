...
@Path("screenSize")
public class ScreenSizeInformation extends Application{
    ...
    public Response getFiles(@PathParam("story") String story) {
    	...
    	String value = hanaConnector.executeQuery("SELECT * FROM " + HANAConnector.tableName + " WHERE ID = 'ScreenSize' AND STORY = '" + story + "'");
    	if (value != null) {
