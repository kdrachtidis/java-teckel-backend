...
@Path("timeline")
public class TimelineInformation extends Application{
    ...
    public Response getFiles(@PathParam("story") String story) {
    	...
    	String value = hanaConnector.executeQuery("SELECT * FROM " + HANAConnector.tableName + " WHERE ID = 'Timeline' AND STORY = '" + story + "'");
    	if (value != null) {
