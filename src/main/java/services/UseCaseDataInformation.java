...
@Path("useCaseData")
public class UseCaseDataInformation extends Application{
    ...
    public Response getFiles(@PathParam("story") String story) {
    	...
    	String value = hanaConnector.executeQuery("SELECT * FROM " + HANAConnector.tableName + " WHERE ID = 'UseCaseData' AND STORY = '" + story + "'");
    	if (value != null) {
